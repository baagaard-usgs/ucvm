...
#define MODEL_FILENAME "1d/1d.conf"

/* Init flag */
int ucvm_1d_create_flag = 0;
...
/* Finalize 1D */
int
ucvm_1d_model_finalize() {
    ucvm_1d_z_dim = 0;
    ucvm_1d_create_flag = 0;
