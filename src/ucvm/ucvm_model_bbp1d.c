...
/* Finalize 1D */
int
ucvm_bbp1d_model_finalize() {
    ucvm_bbp1d_z_dim = 0;
    ucvm_bbp1d_create_flag = 0;
...
/* Version 1D */
int
ucvm_bbp1d_model_version(int id,
                         char *ver,
                         int len) {
    if (id != ucvm_bbp1d_id) {
...
int
ucvm_bbp1d_get_model(ucvm_model_t *m) {
